...
st.markdown('<div class="main-header">🇳🇬 Stock Price Forecasting (GRU RNN)</div>', unsafe_allow_html=True)
st.markdown('<div class="sub-header">Stock Price Prediction using GRU RNN</div>', unsafe_allow_html=True)
